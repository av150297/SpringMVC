...
<body>
	<c:forEach items="${employees}" var="employee">
		    <tr>      
		        ...
		        <a href="/dbms/admin/employees/${employee.empId}"><button type="button">Disable</button></a>
		        </c:if>
		        <c:if test="${employee.status==0}">
		        <a href="/dbms/admin/employees/${employee.empId}"><button type="button">Enable</button></a>
		        </c:if>
		    </tr>
		    <br><br>
		</c:forEach>
