...
<body>
    ...
    <form:input path="offer_id" type="text" required="required" placeholder="Offer Code"/>
	<form:errors path="offer_id" />
	
	<label for="name"><b>Offer Name</b></label>
    <form:input path="name" type="text" required="required" placeholder="Offer Name"/>
