...
public class WholeSaleSellerdaoImp implements WholeSaleSellerdao {
	...
	public void addnewseller(WholeSaleSeller seller) {
		...
		jdbcTemplate.update(sql,new Object[] {seller.getSellerId(),seller.getName(),seller.getMail(),seller.getAddress()});
	...
	public boolean checksellerexists(WholeSaleSeller seller) {
		...
		int count = jdbcTemplate.queryForObject(sql, new Object [] {seller.getSellerId()}, Integer.class);
